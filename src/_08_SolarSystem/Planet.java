...
public class Planet {
    ...
    public Planet(int diameterPixels, Color planetColo, int distanceFromSun, int orbitalPerio) {
        this.diameter = diameterPixels;
        this.planetColor=planetColo;
        this.distanceFromSun = distanceFromSun;
        this.orbital=orbitalPerio;
    }
    ...
    public void draw(Graphics g, int numDays) {
         ...
         */
        int avgDistFromSun = distanceFromSun;     // You can choose a different scaling than divided by 10
        int orbitalPeriod = orbital;
